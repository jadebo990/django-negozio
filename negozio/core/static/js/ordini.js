...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    document.getElementById("btnAggiungiProdotto").addEventListener("click", () => {
        ...
        for(const d of dettagliProdotti) {
            if(d.prodotto == prodottoId) {
                alert("Errore! prodotto già inserito. Eliminalo prima se vuoi modificarne la quantità.");
                return;
            }
        }
    ...
    document.getElementById("formOrdine").addEventListener("submit", async (e) => {
        ...
        axios.post('/api/ordini/', {
            ...
            .then(response => {
                alert("Successo! ordine creato correttamente.");
